            ...
            <div className="navbar text-lg font-semibold py-5">
                    ...
                    <div className="hidden lg:flex">
                        <Link to={"/"}>
                            <div className="flex gap-3 items-center">
                                <img className="w-16" src="https://i.ibb.co/1JDtbsT/ab.png" alt="Social Event" />
                                <h2 className="text-3xl font-bold text-[#E84F74]">Task</h2>
                            </div>
                        </Link>
                    </div>
                </div>
                <div className="navbar-center">
                    ...
                    <div className="lg:hidden ">
                        <Link to={"/"}>
                            <div className="flex gap-3 items-center">
                                <img className="w-12" src="https://i.ibb.co/1JDtbsT/ab.png" alt="Social Event" />
                                <h2 className="text-base font-bold text-[#E84F74] md:flex">Task</h2>
                            </div>
                        </Link>
                    </div>
                </div>
